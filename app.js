...
app.get("/", function (req, res) {
  res.render("home", { contentHome: homeStartingContent , allThePosts: posts});
});
...
app.post("/compose", function (req, res) {
  const post = {
    title: req.body.titleOfAPost,
    content: req.body.contentOfAPost,
  };
  posts.push(post);
  res.redirect("/");
});
app.get("/posts/:title", function(req,res){
  ...
  posts.forEach(post => {
    if(_.lowerCase(post.title) == requestedTitle){ 
      ...
      res.render("post", {theTitle: title, theContent: content });
    }
  });
